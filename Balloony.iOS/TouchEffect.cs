...
[assembly: ExportEffect(typeof(Balloony.iOS.TouchEffect), "TouchEffect")]
namespace Balloony.iOS
{
    public class TouchEffect : PlatformEffect
    {
        ...
        protected override void OnAttached()
        {
            ...
            Balloony.TouchEffect effect = (Balloony.TouchEffect)Element.Effects.FirstOrDefault(e => e is Balloony.TouchEffect);
    ...
    class TouchRecognizer : UIGestureRecognizer
    {
        ...
        public TouchRecognizer(Element element, UIView view, Balloony.TouchEffect touchEffect)
        {
